...
impl FunctionGenerator {
    ...
    pub fn fn_selector(&self) -> TokenStream {
        ...
        let name = &self.name;
        quote! {::fuels::types::fn_selector::resolve_fn_selector(#name, &[#(#param_type_calls),*])}
    }
...
mod tests {
    ...
    fn correct_fn_selector_resolving_code() -> Result<()> {
        ...
        assert_eq!(
            ...
            r#":: fuels :: types :: fn_selector :: resolve_fn_selector ("test_function" , & [< self :: CustomStruct :: < u8 > as :: fuels :: types :: traits :: Parameterize > :: param_type ()])"#
        );
